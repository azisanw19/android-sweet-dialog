...
class DialogConfirmation(private val context: Context) : Dialog(context) {

    private var binding: DialogConfirmationBinding = DialogConfirmationBinding.inflate(layoutInflater)
     ...
     */
    fun setTitle(title: String): DialogConfirmation {
     ...
     */
    fun setTitleTextSize(@DimenRes size: Int): DialogConfirmation {
     ...
     */
    fun setImageDrawable(drawable: Drawable?): DialogConfirmation {
     ...
     */
    fun setImageURI(uri: Uri): DialogConfirmation {
     ...
     */
    fun setDescribe(describe: String): DialogConfirmation {
     ...
     */
    fun setDescribe(@DimenRes size: Int): DialogConfirmation {
     ...
     */
    fun setPositiveText(positiveText: String): DialogConfirmation {
     ...
     */
    fun setNegativeText(negativeText: String): DialogConfirmation {
     ...
     */
    fun setOnPositiveClickListener(listener: () -> Unit) : DialogConfirmation {
     ...
     * @param listener callback function
     */
    fun setOnNegativeClickListener(listener: () -> Unit) : DialogConfirmation {
